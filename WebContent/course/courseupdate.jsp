						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td width="60%"><input type="hidden" name="id" id="id"
									value="${course.id}" /><input type="text" name="name"
									id="name" value="${course.name}" class="span1-10" /><font
									color="red">*</font></td>
							</tr>
							<tr>
								<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">授课老师：</td>
								<td width="60%"><input type="text" name="teacher"
									id="teacher" value="${course.teacher}" class="span1-10" /><font
									color="red">*</font></td>
							</tr>
							<tr>
								<td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">课时数：</td>
								<td width="60%"><input type="text" name="period"
									id="period" value="${course.period}" class="span1-10" /><font
									color="red">*</font></td>
							</tr>
